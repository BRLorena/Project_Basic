...
public class MovimentacaoPage extends BasePage {
	...
	public List<String>obtainError() {
		...
		List <String> retorno = new ArrayList<String>(); //Criar uma list do tipo String onde armazenara o retorno das msg's de erro
		
		for(WebElement erro: erros) {
			retorno.add(erro.getText()); //Para cada erro encontrado dentro da List de webElement add a list de String retorno
		}
		return retorno;
	}
} 
